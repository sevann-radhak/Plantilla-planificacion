...
\begin{figure}[htpb]
  \begin{center}
    \begin{ganttchart}[
      ...
      \ganttgroup{1.0: Duración Total}{2024-07-01}{2024-12-31} \\
      
      % Grupo de tareas 1: Recolección y preprocesamiento de datos
      \ganttgroup{1.1: Recolección y preprocesamiento de datos}{2024-08-01}{2024-12-01} \\
      \ganttbar[name=T1]{1.1.1: Definir y establecer conexión}{2024-08-01}{2024-08-07} \\
      \ganttbar[name=T2]{1.1.2: Desarrollar scripts de extracción}{2024-08-08}{2024-08-14} \\
      \ganttbar[name=T3]{1.1.3: Validar integridad y calidad de datos}{2024-08-15}{2024-08-21} \\
      \ganttbar[name=T4]{1.1.4: Documentar proceso de obtención}{2024-08-22}{2024-08-25} \\
      \ganttbar[name=T5]{1.1.5: Limpieza y normalización de datos}{2024-08-26}{2024-09-14} \\
      \ganttbar[name=T6]{1.1.6: Aplicación de técnicas de imputación}{2024-09-15}{2024-12-01} \\
      
      % Grupo de tareas 2: Desarrollo y evaluación de modelos de IA
      \ganttgroup{1.2: Desarrollo y evaluación de modelos de IA}{2024-08-01}{2024-12-01} \\
      \ganttbar[name=T7]{1.2.1: Investigar y seleccionar algoritmos}{2024-08-01}{2024-08-14} \\
      \ganttbar[name=T8]{1.2.2: Implementar modelos seleccionados}{2024-08-15}{2024-09-14} \\
      \ganttbar[name=T9]{1.2.3: Entrenar y ajustar modelos}{2024-09-15}{2024-11-15} \\
      \ganttbar[name=T10]{1.2.4: Comparar precisión y eficiencia}{2024-11-16}{2024-12-01} \\
      
      % Grupo de tareas 3: Implementación del sistema y documentación
      \ganttgroup{1.3: Implementación del sistema y documentación}{2024-08-01}{2024-12-01} \\
      \ganttbar[name=T11]{1.3.1: Diseñar la arquitectura del sistema}{2024-08-01}{2024-08-14} \\
      \ganttbar[name=T12]{1.3.2: Implementar proceso de predicciones y alertas}{2024-08-15}{2024-09-15} \\
      \ganttbar[name=T13]{1.3.3: Integrar modelos de IA con la plataforma}{2024-09-16}{2024-11-30} \\
      \ganttbar[name=T14]{1.3.4: Elaborar documentación técnica}{2024-12-01}{2024-12-01} \\
      
      % Grupo de tareas 4: Gestión del proyecto y presentación
      \ganttgroup{1.4: Gestión del proyecto y presentación}{2024-07-01}{2024-12-31} \\
      \ganttbar[name=T15]{1.4.1: Gestionar riesgos y problemas}{2024-07-01}{2024-12-01} \\
      \ganttbar[name=T16]{1.4.2: Preparar la presentación pública}{2024-12-02}{2024-12-31} \\
      
      % Grupo de tareas 5: Generación de entregables y proceso de cierre
      \ganttgroup{1.5: Generación de entregables y proceso de cierre}{2024-12-01}{2024-12-31} \\
      \ganttbar[name=T17]{1.5.1: Inicio elaboración memoria técnica}{2024-12-01}{2024-12-10} \\
      \ganttbar[name=T18]{1.5.2: Revisión y correcciones de la memoria}{2024-12-11}{2024-12-15} \\
      \ganttbar[name=T19]{1.5.3: Fin de elaboración memoria técnica}{2024-12-16}{2024-12-22} \\
      \ganttbar[name=T20]{1.5.4: Revisión y correcciones de la memoria}{2024-12-23}{2024-12-27} \\
      \ganttbar[name=T21]{1.5.5: Elaboración de la presentación final}{2024-12-28}{2024-12-30} \\
      \ganttmilestone[name=M1]{1.5.6: Ensayo de la presentación}{2024-12-31} \\
      
      % Elaboración de publicación científica
      \ganttgroup{1.6: Elaboración de publicación científica}{2024-08-01}{2024-12-31} \\
      \ganttbar[name=T22]{1.6.1: Elaboración de la publicación científica}{2024-08-01}{2024-11-30} \\
      \ganttmilestone[name=M2]{1.6.2: Revisión de la publicación}{2024-11-30} \\
      \ganttbar[name=T23]{1.6.3: Corrección y finalización}{2024-12-01}{2024-12-15} \\
    \end{ganttchart}
  \end{center}
