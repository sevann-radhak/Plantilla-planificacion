...
\begin{enumerate}
\item Grupo de tareas 1: recolección y preprocesamiento de datos (130 h)
\begin{enumerate}
\item Tarea 1: definir y establecer la conexión con la base de datos de la DINAC (15 h)
\item Tarea 2: desarrollar scripts para la extracción automática de datos históricos y actuales (15 h)
\item Tarea 3: validar la integridad y calidad de los datos recolectados (15 h)
\item Tarea 4: documentar el proceso de obtención de datos (10 h)
\item Tarea 5: limpieza y normalización de datos para eliminar valores atípicos y errores (35 h)
...
\begin{enumerate}
\item Tarea 7: investigar y seleccionar algoritmos apropiados para el análisis de datos meteorológicos (25 h)
\item Tarea 8: implementar los modelos seleccionados en el entorno de desarrollo (45 h)
\begin{enumerate}
\item Subtarea 8.1: configurar el entorno de desarrollo para la implementación de modelos (10 h)
\item Subtarea 8.2: desarrollar el código base para el primer modelo de IA (18 h)
\item Subtarea 8.3: desarrollar el código base para el segundo modelo de IA (17 h)
\end{enumerate}
\item Tarea 9: entrenar y ajustar los modelos con datos preprocesados (60 h)
\begin{enumerate}
\item Subtarea 9.1: entrenar el primer modelo de IA con los datos preprocesados (18 h)
\item Subtarea 9.2: entrenar el segundo modelo de IA con los datos preprocesados (17 h)
\item Subtarea 9.3: realizar ajustes y optimizaciones en el primer modelo (12 h)
\item Subtarea 9.4: realizar ajustes y optimizaciones en el segundo modelo (13 h)
\end{enumerate}
\item Tarea 10: comparar la precisión y eficiencia de los modelos implementados con el modelo actual (45 h)
\begin{enumerate}
\item Subtarea 10.1: definir métricas y criterios de evaluación para los modelos (10 h)
\item Subtarea 10.2: realizar pruebas de precisión y eficiencia en el primer modelo (18 h)
\item Subtarea 10.3: realizar pruebas de precisión y eficiencia en el segundo modelo (17 h)
\end{enumerate}
\end{enumerate}
\item Grupo de tareas 3: implementación del Sistema y Documentación (160 h)
\begin{enumerate}
\item Tarea 11: diseñar la arquitectura del sistema de predicción de eventos climáticos extremos (35 h)
\item Tarea 12: implementar el proceso de emisión de predicciones y alertas (35 h)
\item Tarea 13: integrar los modelos de IA con la plataforma desarrollada (35 h)
\item Tarea 14: elaborar la documentación técnica del sistema y los manuales de usuario (20 h)
\item Tarea 15: realizar pruebas de aceptación con el cliente para validar la funcionalidad del sistema (35 h)
\end{enumerate}
\item Grupo de tareas 4: gestión del proyecto (GdP) (40 h)
\begin{enumerate}
\item Tarea 16: reuniones con el cliente (10 h)
\item Tarea 17: entregables GdP hasta sección 5 (4 h)
\item Tarea 18: entregables GdP hasta sección 9 (6 h)
\item Tarea 19: entregables GdP hasta sección 12 (6 h)
\item Tarea 20: entregables GdP hasta sección 15 (4 h)
\item Tarea 21: elaboración presentación GdP (5 h)
\item Tarea 22: revisión y correcciones entregables GdP (5 h)
\end{enumerate}
\item Grupo de tareas 5: generación de entregables y proceso de cierre (90 h)
\begin{enumerate}
\item Tarea 23: inicio elaboración memoria técnica - Taller de Trabajo Final A (40 h)
\item Tarea 24: revisión y correcciones de la memoria (5 h)
\item Tarea 25: fin de elaboración memoria técnica - Taller de Trabajo Final B (30 h)
\item Tarea 26: revisión y correcciones de la memoria (5 h)
\item Tarea 27: elaboración presentación final (8 h)
\item Tarea 28: revisión y correcciones de la presentación final (2 h)
\end{enumerate}
\end{enumerate}
